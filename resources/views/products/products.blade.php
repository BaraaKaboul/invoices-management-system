...
@section('content')
    ...
    @if(Session::has('Delete'))
        <div class="alert alert-success alert-dismissible fade show" role="alert" style="padding-right: 50px">
    ...
    @error('product_name')
    <div class="alert alert-danger alert-dismissible fade show" role="alert" style="padding-right: 50px">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table key-buttons text-md-nowrap" >
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $product -> sections->section_name }}</td>{{--ال sections من العلاقة بالمودل وجبنا الsection_name من جدول الsections--}}
