...
{{--                                بهاي الحالة فقط رح تطلع خانة الاشعارات فقط للي حالتو owner--}}
{{--                            فينا نعملها عن طريق الصلاحيات ونحدد مين لبيغضر يشوفها ومين لا بس منضيف الصلاحية للسيدر تبعها ونعمل ريفريش للداتابيز ونحط هون can() --}}
									...
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                                <a href="{{route('All.Read')}}">وضع علامة مقروء</a>


                                            </span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12">
                                            <h6 style="color: yellow" id="unreadnotifivations_count">
                                            لديك ({{ auth()->user()->unreadNotifications->count() }}
                                            ) إشعار غير مقروء</h6>
                                        </p>
									</div>
